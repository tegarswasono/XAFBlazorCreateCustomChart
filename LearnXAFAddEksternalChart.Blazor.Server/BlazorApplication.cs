...
namespace LearnXAFAddEksternalChart.Blazor.Server {
    public partial class LearnXAFAddEksternalChartBlazorApplication : BlazorApplication {
        public LearnXAFAddEksternalChartBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void LearnXAFAddEksternalChartBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
